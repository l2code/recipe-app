...
- Schema is exported (`room.schemaLocation`) to `app/schemas/` for
  `MigrationTestHelper`-based migration testing once a version 2 exists
  (see `RecipeDatabaseMigrationTest`).
